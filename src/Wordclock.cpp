...
// const WordClockState Wordclock::TEMPERATURE({0x0000, 0x0a20, 0x0200, 0x3f00, 0x0902, 0x1024, 0x0021, 0x0000});
// const WordClockState Wordclock::DYNAMICBRIGHTNESS({0x4200, 0x0444, 0x80e1, 0xde0f, 0x8038, 0x7c40, 0x8042, 0x0001});
